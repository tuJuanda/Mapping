...
Tentu, ini adalah file modification-guide.md yang telah diperbarui dengan menyertakan poin nomor 7. Salin semua teks di dalam blok kode di bawah ini dan simpan sebagai file modification-guide.md.
